...
export JOB_NAME=optimize_biBTSP_synthetic_hybrid_norm3_"$DATE"
sbatch <<EOT
#!/bin/bash -l
#SBATCH -J $JOB_NAME
...
ibrun -n 840 python3 -m nested.optimize --config-file-path=config/optimize_biBTSP_synthetic_hybrid_norm3_config.yaml \
